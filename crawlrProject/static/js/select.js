...
function addKeywordSelect(){
  ...
  entry += "</select>";
  entry += "<div class='form-group' style='margin-left:5%; width: 95%;' id='keyword-options-" + num_chosen.toString() +"'></div>";
  if (num_chosen < 3){
...
function displayOptions(){
  ...
  entry += "<input id='" + key +"-hours' class='form-control' type='number' min='0' step='1' placeholder='Max Hours' style='display:inline;width: 50%%'>";
  entry += "<p style='display:inline'> Hours </p>"
  entry += "<input id='" + key +"-minutes' class='form-control' type='number' min='0' max='59' step='1' placeholder='Max Mins' style='display:inline;width: 50%'>";
